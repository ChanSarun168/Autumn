...
const models: TsoaRoute.Models = {
    ...
    "Ifood": {
        ...
        "properties": {
            ...
            "cuisine": {"dataType":"string"},
            "spiciness": {"dataType":"string"},
            "preparationTime": {"dataType":"string"},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "ChatResponse": {
        ...
        "properties": {
            ...
            "data": {"dataType":"array","array":{"dataType":"nestedObjectLiteral","nestedProperties":{"thumbnail":{"dataType":"string","required":true},"type":{"dataType":"string","required":true},"price":{"dataType":"double","required":true},"name":{"dataType":"string","required":true}}},"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/auth/admin',
            ...
            ...(fetchMiddlewares<RequestHandler>(AdminController.prototype.AdminSignup)),

            async function AdminController_AdminSignup(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/auth/admin/:id',
            ...(fetchMiddlewares<RequestHandler>(AdminController)),
            ...(fetchMiddlewares<RequestHandler>(AdminController.prototype.GetAdminInfo)),

            async function AdminController_GetAdminInfo(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.get('/table',
            ...(fetchMiddlewares<RequestHandler>(TableController)),
            ...(fetchMiddlewares<RequestHandler>(TableController.prototype.GetAllTable)),

            async function TableController_GetAllTable(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
            };
        ...
        app.get('/table/:tableId',
            ...(fetchMiddlewares<RequestHandler>(TableController)),
            ...(fetchMiddlewares<RequestHandler>(TableController.prototype.GetTable)),

            async function TableController_GetTable(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.post('/user/info',
            ...
            ...(fetchMiddlewares<RequestHandler>(userController.prototype.UserInfo)),

            async function userController_UserInfo(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    request: {"in":"request","name":"request","required":true,"dataType":"object"},
            };
        ...
        app.post('/user',
            ...(fetchMiddlewares<RequestHandler>(userController)),
            ...(fetchMiddlewares<RequestHandler>(userController.prototype.UserSignup)),

            async function userController_UserSignup(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
